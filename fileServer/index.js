...
(function (port) {
    ...
    var path = require('path'),
        ...
        options = {
            tmpDir: __dirname + '/../server/tmp',
            publicDir: __dirname + '/../server/public',
            baseUploadDir: __dirname + '/../server/public/files',
    ...
    FileInfo.prototype.safeName = function () {
        ...
        var indexExt = this.name.lastIndexOf('.');
        if (indexExt != -1) {
            var ext = this.name.substring(indexExt);
            this.name = GUID() + ext;
        } else {
            this.name = GUID();
        }
    ...
    UploadHandler.prototype.get = function (username) {
        options.uploadDir = options.baseUploadDir + '/' + username;
        options.uploadUrl = '/files/' + username + '/';
        var handler = this,
            files = [];
        fs.mkdir(options.uploadDir, function(e) {
    ...
    UploadHandler.prototype.post = function (username) {
        options.uploadDir = options.baseUploadDir + '/' + username;
        options.uploadUrl = '/files/' + username + '/';
        var handler = this,
